...
regenerates the skill from `src/skill.ts`; never hand-edit `skills/memoryintel/SKILL.md`
...
```bash
npm install
npm run build   # compiles dist/, regenerates skills/memoryintel/SKILL.md
